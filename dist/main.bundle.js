...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__filegen_service__ = __webpack_require__(80);
...
var AppComponent = (function () {
    function AppComponent(fileGenService) {
    ...
    AppComponent.prototype.generateFile = function (number) {
        var _this = this;
        debugger;
        var params = { number: parseInt(number.value), values: this.checks };
        this.fileGenService.generateFile(params).subscribe(function (value) {
            _this.message = value;
        });
    };
    return AppComponent;
...
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__filegen_service__["a" /* FileGenService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__filegen_service__["a" /* FileGenService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__filegen_service__["a" /* FileGenService */]) === "function" && _a || Object])
], AppComponent);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileGenService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileGenService = (function () {
    function FileGenService(http) {
        this.http = http;
        this.fileGenUrl = 'api/genfile';
    }
    FileGenService.prototype.generateFile = function (data) {
        return this.http.post(this.fileGenUrl, data)
            .map(this.extract)
            .catch(this.handleError);
    };
    FileGenService.prototype.extract = function (res) {
        var body = res.json();
        return body.message || '';
    };
    FileGenService.prototype.handleError = function (error, caught) {
        var errMsg;
    ...
    return FileGenService;
}());
FileGenService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */]) === "function" && _a || Object])
], FileGenService);

var _a;
//# sourceMappingURL=filegen.service.js.map
